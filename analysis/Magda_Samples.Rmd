...
Cellbender.master <- "/shares/rheumatologie.usz/Sophie/Gabi_Projects/CellBender_checks_data/Cellbender_output_2ndrun"
...
ggplot(counts_wide, aes(x = Raw, y = Cellbender)) +
  ...
  coord_equal(xlim = c(1000, 3500), ylim = c(1000, 2500)) +
  # Layout styling
  theme_bw() +
  labs(
